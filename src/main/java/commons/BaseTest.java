...
//    }
    ...
    protected WebDriver getBrowerDriverUrl(String browserName,String url) {
        BrowserList browser = BrowserList.valueOf(browserName.toUpperCase());
...
//        driver.manage().window().setSize(new Dimension(1920, 1080));
    ...
    protected org.openqa.selenium.WebDriver getBrowserDriverCapabilities(String browserName, String url) {
        BrowserList browser = BrowserList.valueOf(browserName.toUpperCase());
